...
//SYNTAX RULES
//Program
program: nnls decllist (mainfunc nls) decllist EOF;

//Main function
mainfunc: FUNC MAIN LP RP nnls stmt;

//Declaration
decllist: decl nls decllist | ; //nullable
decl: funcdecl | vardeclstmt;

//Function declaration
funcdecl: FUNC IDENTIFIER LP paramlist RP nnls (stmt|);
paramlist: paramprime | ; //nullable
paramprime: param COMMA paramprime | param;
param: primetype IDENTIFIER ((LS numlist RS)|);
numlist: NUMBERLIT COMMA NUMBERLIT | NUMBERLIT; //not nullable
...
elemexpr: (IDENTIFIER | funccallstmt) LS indexop RS;
...
STRINGLIT: DQ CHAR* DQ {self.text = self.text[1:-1]};
fragment DQ: '"';
